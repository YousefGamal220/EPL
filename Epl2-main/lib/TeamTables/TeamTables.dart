...
import 'package:arseli/TeamTables/Doc.dart';
...
class TeamTables {
    ...
    TeamTables({this.docs, this.hasNextPage, this.hasPrevPage, this.limit, this.nextPage, this.page, this.pagingCounter, this.prevPage, this.totalDocs, this.totalPages});

    factory TeamTables.fromJson(Map<String, dynamic> json) {
        return TeamTables(
