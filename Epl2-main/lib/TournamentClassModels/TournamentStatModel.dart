...
class TournamentStatModel {
    ...
    TournamentStatModel({this.docs, this.hasNextPage, this.hasPrevPage, this.limit, this.nextPage, this.page, this.pagingCounter, this.prevPage, this.totalDocs, this.totalPages});

    factory TournamentStatModel.fromJson(Map<String, dynamic> json) {
